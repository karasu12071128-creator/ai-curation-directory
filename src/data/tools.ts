...
export const categories = [
  { id: 'text-generation', name: '文章生成AI', icon: '✍️', count: 13 },
  { id: 'image-generation', name: '画像生成AI', icon: '🎨', count: 17 },
  { id: 'coding', name: 'コーディング支援AI', icon: '💻', count: 13 },
  { id: 'video-generation', name: '動画生成AI', icon: '🎬', count: 15 },
  { id: 'audio', name: '音声・音楽AI', icon: '🎵', count: 15 },
  { id: 'productivity', name: 'ビジネス・生産性', icon: '💼', count: 20 },
  { id: 'marketing', name: 'マーケティングAI', icon: '📈', count: 13 },
  { id: 'design', name: 'デザインAI', icon: '🖌️', count: 17 },
  { id: 'research', name: 'リサーチ・分析AI', icon: '🔍', count: 13 },
  { id: 'customer-support', name: 'カスタマーサポートAI', icon: '💬', count: 15 }];
